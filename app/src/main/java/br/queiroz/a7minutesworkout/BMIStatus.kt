...
enum class BMIStatus(
    ...
    VERY_SEVERE_UNDERWEIGHT("Very severely underweight","Oops! You really need to take better care of yourself!" +
            " Eat more!" ),
    SEVERELY_UNDERWEIGHT("Severely underweight","Oops!You really need to take better care of yourself!" +
            " Eat more!" ),
    UNDERWEIGHT("Underweight", "Oops! You really need to take better care of yourself!" +
            " Eat more!"),
    NORMAL("Normal", "Congratulations! You are in a good shape!"),
    OVERWEIGHT("Overweight", "Oops! You really need to take care of your yourself!" +
            " Workout maybe!"),
    MODERATELY_OBESE("Obese Class | (Moderately obese)",
        "Oops! You really need to take care of your yourself!" +
                " Workout maybe!"),
    SEVERELY_OBESE("Obese Class || (Severely obese)",
        "OMG! You are in a very dangerous condition! Act now!"),
    VERY_SEVERELY_OBESE("Obese Class ||| (Very Severely obese)",
        "OMG! You are in a very dangerous condition! Act now!")
    ;
